...
export default function Strings() {
  return {
    ...
    presaleStage: "PRÉ-VENDA 1 ESTÁ OFICIALMENTE ABERTA",

    // buyBeforeTheEnd: "Hurry before the end of presale!",
    buyBeforeTheEnd: "Please wait for announcements",
    buyBefore: "Apresse-se antes da venda antecipada 2 aumentos de preços para",
    soldTtl: "VENDIDO",
    raisedTtl: "RAIZADO",
    ...
    aboutDesc1: `With flashy combat, stellar graphics, and multiple game modes,  ${config.appName} is the first AAA-quality F2P hack-and-slash RPG on the blockchain release at Polygon`,
    aboutDesc2:
    ...
    timerLabel: "A venda antecipada 1 termina em :",
