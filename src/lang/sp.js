...
export default function Strings() {
  return {
    ...
    presaleStage: "LA PREVENTA 1 ESTÁ OFICIALMENTE ABIERTA",

    // buyBeforeTheEnd: "Hurry before the end of presale!",
    buyBeforeTheEnd: "Please wait for announcements",
    buyBefore:
      "¡Date prisa antes de que el precio de la Preventa 2 aumente a 0,070 $!",
    soldTtl: "Vendido",
    raisedTtl: "RECAUDADO",
    ...
    timerLabel: "La preventa 1 finaliza en",
